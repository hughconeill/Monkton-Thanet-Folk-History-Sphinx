...
Where did Monkton come from, and where does its name come from? The
answer starts well before the parish church or any of the farms and
cottages described elsewhere on this site — with an Anglo-Saxon
cemetery, and a gift from a Saxon queen.
...
## The manor and the priory

In 961, Queen Ediva — mother of Kings Edmund and Eadred — gave the
manor of Monkton to Christ Church Priory, Canterbury, exempting it
from secular service other than defence, castle-repair, and highway
maintenance. By Domesday it was valued at £20 under Edward the
Confessor, rising to £40 under the Normans. It stayed in the
priory's hands until the Dissolution in 1536, when Henry VIII granted
it to his newly-founded Dean and Chapter of Canterbury.

Monkton was also, for a time, a market town: Henry VI granted a
...
Priory under Henry II, along with its dependent chapels at
Birchington and Woodchurch — revoked for a time by Archbishop
Baldwin, then restored by Archbishop Islip around 1360. It once had
twelve stalls for its resident monks and priests. In 1377, Archbishop
Langham formally endowed the vicarage, setting the vicar's stipend at
"twelve pounds and twenty pence" a year plus tithes and oblations.

```{admonition} Conflicting evidence
:class: warning

The [list of vicars](../church/clergy.md) — recorded on a board that
stood in the church porch — dates Monkton becoming a vicarage to
1361, sixteen years before Archbishop Langham's 1377 endowment as
given by Hasted. The two may both be right: a vicarage could well
have existed before its stipend was formally fixed. This page hasn't
...
The material on this page comes from external published sources
(linked inline above), rather than the parish's own records — unlike
most of this site, which draws on the churchyard survey, the parish
magazine, and other primary material gathered locally. Corrections
and local knowledge are very welcome — see [About](../about.md) for
how to get in touch.
```
